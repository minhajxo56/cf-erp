...
* @see app/Http/Controllers/UserApplicationController.php:85
...
* @see app/Http/Controllers/UserApplicationController.php:44
* @route '/applications'
*/
...
* @see app/Http/Controllers/UserApplicationController.php:150
...
* @see app/Http/Controllers/UserApplicationController.php:90
...
* @see app/Http/Controllers/UserApplicationController.php:99
* @route '/applications/{application}'
*/
...
* @see app/Http/Controllers/UserApplicationController.php:214
* @route '/applications/{application}'
*/
...
* @see app/Http/Controllers/UserApplicationController.php:187
...
* @see app/Http/Controllers/UserApplicationController.php:159
...
const UserApplicationController = { myApplications, index, create, store, show, edit, update, destroy, escalate, resolve }
