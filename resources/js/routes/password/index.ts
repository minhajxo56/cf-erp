...
/**
* @see \App\Http\Controllers\Auth\ForcePasswordChangeController::forceChange
* @see app/Http/Controllers/Auth/ForcePasswordChangeController.php:13
* @route '/force-password-change'
*/
export const forceChange = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: forceChange.url(options),
    method: 'get',
})

forceChange.definition = {
    methods: ["get","head"],
...
* @route '/force-password-change'
*/
forceChange.url = (options?: RouteQueryOptions) => {
    return forceChange.definition.url + queryParams(options)
}
...
* @route '/force-password-change'
*/
forceChange.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: forceChange.url(options),
    method: 'get',
})
...
* @route '/force-password-change'
*/
forceChange.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: forceChange.url(options),
    method: 'head',
})
...
* @route '/force-password-change'
*/
const forceChangeForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: forceChange.url(options),
    method: 'get',
})
...
* @route '/force-password-change'
*/
forceChangeForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: forceChange.url(options),
    method: 'get',
})
...
* @route '/force-password-change'
*/
forceChangeForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: forceChange.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
forceChange.form = forceChangeForm

/**
* @see \App\Http\Controllers\Auth\ForcePasswordChangeController::forceUpdate
...
* @route '/force-password-change'
*/
const forceUpdateForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: forceUpdate.url(options),
    method: 'post',
})
...
* @route '/force-password-change'
*/
forceUpdateForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: forceUpdate.url(options),
    method: 'post',
})

forceUpdate.form = forceUpdateForm
...
const password = {
    ...
    forceChange: Object.assign(forceChange, forceChange),
    forceUpdate: Object.assign(forceUpdate, forceUpdate),
}
